...
// Step 2: Function to modify robot (pass by value)
    void modifyingRobotbyValue(Robot r) {
        cout<<"Modifying by value"<<endl;
    }

// Step 3: Function to modify robot (pass by reference)
    void modifyingRobotbyReference(Robot& r) {
        cout<<"Modifying by reference"<<endl;
    }
...
int main() {
    ...
    Robot myRobot("Robot1", "Version1", 89);
